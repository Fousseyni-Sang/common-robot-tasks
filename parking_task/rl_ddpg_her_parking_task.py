...
if __name__=="__main__":
  ...
  callback = CallbackList([
      CheckpointCallback(save_freq=30000, save_path="./ddpg_her_checkpoints/"),
      EvalCallback(eval_env, best_model_save_path="./ddpg_her_best_model/", eval_freq=30000),
  ])

  model.learn(total_timesteps=500_000_000, callback=callback, tb_log_name="ddpg_her_first_run")
