...
import os
from parking_envs import ParkingTaskHer
...
if __name__=="__main__":
  ...
  model = PPO("MultiInputPolicy", vec_env, verbose=1, n_steps=256, batch_size=8192,
            tensorboard_log="./ppo_parkingtask_tensorboard/", ent_coef=0.001, n_epochs=10)



  callback = CallbackList([
      CheckpointCallback(save_freq=30000, save_path="./ppo_checkpoints/"),
      EvalCallback(eval_env, best_model_save_path="./ppo_best_model/", eval_freq=30000),
  ])

  model.learn(total_timesteps=500_000_000, callback=callback, tb_log_name="ppo_first_run")
